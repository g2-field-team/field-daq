...
set "Scale Factor (kHz per mA)" 0.246 
...
create DOUBLE "Maximum PID Output (Hz)"
set "Maximum PID Output (Hz)" 100.00
create DOUBLE "Maximum I Term Output (Hz)"
set "Maximum I Term Output (Hz)" 100.00
