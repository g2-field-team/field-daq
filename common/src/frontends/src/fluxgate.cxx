...
extern "C" {
  ...
  INT max_event_size = 0x800000; // 8 MB @EXAMPLE - adjust if neeeded
...
//  }
  db_get_value(hDB,0,"/Equipment/Fluxgate/Settings/writeDebug",&writeDebug,&writeDebugSize,TID_BOOL,0);
  if(writeDebug){
/*    time_t rawTime;
    struct tm * timeinfo;
    char timeBuffer[80];
