#ifndef FIELD_DAQ_FRONTENDS_OBJ_ABS_FIXED_PROBE_SEQUENCER_HH_
#define FIELD_DAQ_FRONTENDS_OBJ_ABS_FIXED_PROBE_SEQUENCER_HH_

/*===========================================================================*\

  author: Matthias W. Smith
  email:  mwsmith2@uw.edu
  file:   abs_fixed_probe_sequencer.hh
...
class AbsFixedProbeSequencer: public hw::EventManagerBase {

public:

  //ctor
  AbsFixedProbeSequencer(std::string conf_file, int num_probes);

  //dtor
  ~AbsFixedProbeSequencer();
...
private:
  ...
  const std::string name_ = "AbsFixedProbeSequencer";
